...
const AboutUsPage = () => (
    <section id="about-section" className="transition-all duration-500 ease-in-out transform opacity-0 translate-y-4 animate-fade-in-up">
        ...
        <div className="text-lg md:text-xl text-black leading-relaxed mb-10 text-justify space-y-4 w-full px-4 md:px-8">
            <p className="text-left md:text-justify">EM Holding to zespół ludzi, którzy od lat działają na rynku nieruchomości w Krakowie.</p>
            <p className="text-left md:text-justify">Zaczynaliśmy od własnych inwestycji – kupowaliśmy mieszkania pod wynajem, remontowaliśmy je, urządzaliśmy, sprzedawaliśmy. Krok po kroku, projekt po projekcie, przechodziliśmy przez wszystkie etapy, zdobywaliśmy doświadczenie i budowaliśmy relacje.</p>
            <p className="text-left md:text-justify">Dziś robimy to samo dla naszych klientów.</p>
            <p className="text-left md:text-justify">Dzięki latom praktyki wiemy, jak skutecznie kupić, wynająć i sprzedać nieruchomość.<br/>Ponieważ sami również inwestujemy, znamy ten proces od podszewki – i potrafimy wczuć się w rolę właściciela, inwestora, osoby kupującej pierwsze mieszkanie.</p>
            <p className="text-left md:text-justify">Dlatego tak dobrze rozumiemy potrzeby naszych klientów.</p>
            <p className="text-left md:text-justify">Dla nas każda nieruchomość to nowy projekt – wyjątkowy i wymagający indywidualnego podejścia.<br/>Podchodzimy do niego z pełnym zaangażowaniem, niezależnie od tego, czy chodzi o sprzedaż, zakup, wynajem czy doradztwo.</p>
            <p className="font-semibold mt-6 text-left md:text-justify">To, co nas wyróżnia?</p>
            <ul className="list-none pl-0 mb-4 text-left md:text-justify">
            ...
            <p className="text-left md:text-justify">Powiedz, czego potrzebujesz – a my znajdziemy najlepsze&nbsp;rozwiązanie.</p>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-32">
            ...
            <div className="flex flex-col items-center">
                ...
                <div className="max-w-xs w-full">
                    ...
                    <p className="text-black font-serif text-left md:text-justify leading-relaxed space-y-2 break-words">
