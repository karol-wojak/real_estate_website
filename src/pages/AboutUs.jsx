...
const AboutUsPage = () => (
  <section id="about-section" className="bg-white p-6 md:p-12 rounded-xl shadow-lg transition-all duration-500 ease-in-out transform opacity-0 translate-y-4 animate-fade-in-up">
    ...
    <h1 className="text-4xl md:text-5xl font-extrabold text-center text-gradient-dark-blue mb-8 leading-tight md:pb-1">About Us</h1>
    ...
    <h2 className="text-3xl font-bold text-center text-gradient-dark-blue mb-8 md:pb-1">Meet the Visionaries</h2>
