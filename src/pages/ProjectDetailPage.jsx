...
    // This part remains exactly as you provided, mapping imgSrc to { src: imgSrc, width, height }
...
            {/* --- NEW: Breadcrumbs Navigation --- */}
            {/* Styled with dark blue (text-blue-800) and gold (text-yellow-500) */}
            <nav className="text-sm font-medium mb-8" aria-label="Breadcrumb">
              <ol className="list-none p-0 inline-flex items-center">
                <li>
                  {/* Link to the main portfolio/home page */}
                  <Link to="/" className="text-blue-800 hover:text-yellow-500 transition-colors font-semibold">
                    Realizacje
                  </Link>
                </li>
                <li>
